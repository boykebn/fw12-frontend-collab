  ...
  return (
    <div className="App bg-[#E5E5E5]">
      ...
      <div className="bg-white">
        <div className="pl-[150px] pr-[115px] pt-[85px] flex mb-[100px]">
          <div className="w-[500px] pt-[110px] mr-[69px]">
            <div className="mb-[20px]">
              <span className="text-[#1F2A36] text-[44px] leading-[70px]">Talenta terbaik negeri untuk perubahan revolusi 4.0</span>
            </div>
        ...
        <div className="pl-[150px] pr-[115px] pt-[85px] flex mb-[100px]">
          ...
          <div className="pt-[25px]">
            <div className="w-[460px] mb-[34px]">
              <span className="text-[#1F2A36] text-[36px]">Kenapa harus mencari tallent di peworld</span>
            </div>
            <div>
        ...
        <div className="pl-[274px] pr-[109px] flex mb-[76px]">
          <div className="pt-[50px]">
            <div className="text-[#1F2A36] text-[36px] leading-[56px] font-semibold mb-[12px]">Skill Tallent</div>
            <div className="text-[18px] text-[#46505C] leading-[28px] w-[460px] mb-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.</div>
            <div className="flex">
        ...
        <div className="bg-[#E5E5E5] pb-[103px]">
          <div className="text-center pt-[80px] pb-[52px]">
            <span className="text-[#1F2A36] text-[36px] leading-[56px] font-semibold">Their opinion about peworld</span>
          </div>
          <div className="flex justify-center">
            <div className="mr-[28px]">
              <div className="bg-white shadow-lg py-[36px] px-[76px]">
            ...
            <div className="mr-[28px]">
              <div className="bg-white shadow-lg py-[36px] px-[76px] h-full">
                <div className="flex justify-center items-center">
                  <img src={require("./assets/images/Ellipse.png")} alt="ellipse" />
        ...
        <div className="bg-white">
          <div className="px-[150px] py-[129px]">
            <div className="border-1 bg-[#5E50A1] rounded-tl-[50px] rounded-br-[50px]">
              <div className="py-[58px] px-[70px] flex">
                <div className="flex-1">
                  <div className="text-[36px] text-white w-[230px]">Lorem ipsum dolor sit amet</div>
                </div>
