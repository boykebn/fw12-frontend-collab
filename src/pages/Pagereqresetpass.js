    ...
    return (
        <div className="bg-[#F0F5F9] h-screen flex justify-center items-center">
            <div className='relative'>
                <div className="bg-white w-fit py-10 px-40 rounded-2xl flex flex-col justify-center items-center">
                    ...
                    <button className='bg-[#FBB017] py-1 px-10 rounded text-white mb-10'>Change Password</button>
                </div>
