            ...
            <div className="md:basis-1/2 bg-[#E5E5E] overflow-y-auto">
                <div className="py-28 px-16">
                    ...
                    <form>
                        ...
                        <Link to='/login' className="flex justify-center bg-[#FBB017] rounded text-white w-full py-2 my-5">Daftar</Link>
                    </form>
                    <p className="text-center">Anda sudah punya akun? <Link to='/login' className="text-[#FBB017]">Masuk disini</Link></p>
                </div>
            </div>
        </div>
    )
