  ...
  return (
    <div className="font-openSans">
      ...
      <div className="bg-[#E5E5E5] ">
            ...
            <div className="bg-white rounded-[6px] hidden lg:block w-max">
              <div className="pl-[20px] pr-[10px] py-[6px] flex items-center">
                <div className="flex-1 text-[14px] text-[#9EA0A5] leading-[20px] relative">
                  ...
                  />
                  <CiSearch className="absolute w-8 h-8 top-3 right-3 border-1 border-black"/>
                </div>
        ...
        <main className="grid px-3 justify-center md:flex md:flex-col lg:flex lg:flex-col md:pl-10 md:pr-32 lg:pl-[110px] lg:pr-[170px] pb-[50px] gap-5 border-[1px] border-black">
          {profile?.results?.map((bio) => (
            <div className="flex flex-col justify-start pt-10 gap-10 mx-10 items-center bg-white w-80 md:w-full lg:w-full md:flex md:flex-row md:pl-[20px] md:pt-[21px] md:pb-[38px] md:pr-[20px] md:mb-[1px] rounded-[8px] lg:justify-start border-[1px] border-black">
              <div>
                <img className="w-28 md:w-[120px] md:h-[120px] md:rounded-[50%] lg:w-[120px] lg:h-[120px] lg:rounded-[50%] border-[1px] border-black" src={require("../assets/images/testi1.png")} alt="testi1" />
              </div>
              <div className="flex flex-col justify-center items-center gap-5 w-full md:w-[19rem] md:gap-2 md:items-start lg:w-[42rem] lg:p-2 border-[1px] border-black">
                <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 justify-center items-center border-[1px] border-black">
