    ...
    <div>
      ...
      <div className="bg-[#E5E5E5]">
            ...
            <div className="bg-white rounded-[6px]">
              <div className="pl-[20px] pr-[10px] py-[6px] flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <button className=" border-1 bg-[#5E50A1] py-[17px] px-[34px] rounded text-white">Search</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <main className="px-[150px] pb-[50px]">
          <div className="bg-white flex pl-[20px] pt-[21px] pb-[38px] pr-[77px] mb-[1px] rounded-[8px]">
            <div className="mr-[35px] flex items-center">
              <img className="w-[100px] h-[100px]" src={require("../assets/images/testi1.png")} alt="testi1" />
            </div>
            <div className="flex-1">
              <div>
                <span className="text-[#1F2A36] text-[22px] font-bold">Louis Tomlinson</span>
              </div>
              ...
              <div>
                <button className="border-1 bg-[#FBB01799] rounded-[4px] py-[5px] px-[23px] text-white">PHP</button>
              </div>
            </div>
        ...
        <div className="px-[150px] pb-[70px] text-[#9EA0A5] text-[18px] flex justify-center">
          ...
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">1</button>
          </div>
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">2</button>
          </div>
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">3</button>
          </div>
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">4</button>
          </div>
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">5</button>
          </div>
          <div className="mr-[14px]">
            <button className="border-1 bg-white rounded py-[15.5px] px-[24px]">6</button>
          </div>
          <div className="mr-[14px]">
            <button>
